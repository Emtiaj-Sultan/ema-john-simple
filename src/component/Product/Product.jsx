...
const Product = (props) => {
    ...
    return (
        <div className="product w-[300px] h-[510px] border-[1px] border-solid border-[#95A0A7] rounded-[8px] relative">
            ...
            <button className='w-full py-2 bg-[#FFE0B3] border-[1px] border-solid border-[#95A0A7] rounded-b-lg absolute bottom-0 hover:bg-amber-500'>Add to Cart <FontAwesomeIcon icon={faCartPlus} className="ml-1"></FontAwesomeIcon></button>
        </div>
    );
};
